...
// OpenBrowser provides a mock function for the type ServeInterfaceMock
func (_mock *ServeInterfaceMock) OpenBrowser(outputDirectory string, inputFilePath string) {
	_mock.Called(outputDirectory, inputFilePath)
	return
}
...
func (_c *ServeInterfaceMock_OpenBrowser_Call) RunAndReturn(run func(outputDirectory string, inputFilePath string)) *ServeInterfaceMock_OpenBrowser_Call {
	_c.Run(run)
	return _c
}

// StartLiveReloader provides a mock function for the type ServeInterfaceMock
func (_mock *ServeInterfaceMock) StartLiveReloader(port int, outputDirectory string, inputFilePath string) {
	_mock.Called(port, outputDirectory, inputFilePath)
	return
}
...
func (_c *ServeInterfaceMock_StartLiveReloader_Call) RunAndReturn(run func(port int, outputDirectory string, inputFilePath string)) *ServeInterfaceMock_StartLiveReloader_Call {
	_c.Run(run)
	return _c
}

// StartServer provides a mock function for the type ServeInterfaceMock
func (_mock *ServeInterfaceMock) StartServer(port int, outputDirectory string) {
	_mock.Called(port, outputDirectory)
	return
}
...
func (_c *ServeInterfaceMock_StartServer_Call) RunAndReturn(run func(port int, outputDirectory string)) *ServeInterfaceMock_StartServer_Call {
	_c.Run(run)
	return _c
}
