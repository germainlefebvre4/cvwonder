...
// Render provides a mock function for the type RenderInterfaceMock
func (_mock *RenderInterfaceMock) Render(cv model.CV, baseDirectory string, outputDirectory string, inputFilePath string, themeName string, exportFormat string) {
	_mock.Called(cv, baseDirectory, outputDirectory, inputFilePath, themeName, exportFormat)
	return
}
...
func (_c *RenderInterfaceMock_Render_Call) RunAndReturn(run func(cv model.CV, baseDirectory string, outputDirectory string, inputFilePath string, themeName string, exportFormat string)) *RenderInterfaceMock_Render_Call {
	_c.Run(run)
	return _c
}
