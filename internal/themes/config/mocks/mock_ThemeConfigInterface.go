...
// VerifyThemeMinimumVersion provides a mock function with given fields: cvwonderVersion
func (_m *ThemeConfigInterfaceMock) VerifyThemeMinimumVersion(cvwonderVersion string) bool {
	ret := _m.Called(cvwonderVersion)
...
func (_c *ThemeConfigInterfaceMock_VerifyThemeMinimumVersion_Call) Return(_a0 bool) *ThemeConfigInterfaceMock_VerifyThemeMinimumVersion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ThemeConfigInterfaceMock_VerifyThemeMinimumVersion_Call) RunAndReturn(run func(string) bool) *ThemeConfigInterfaceMock_VerifyThemeMinimumVersion_Call {
	_c.Call.Return(run)
	return _c
}
