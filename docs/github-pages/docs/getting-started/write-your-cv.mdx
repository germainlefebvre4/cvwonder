...
| Experience | Your professional experience (optional). |
...
| Field | Description |
| --- | --- |
| Years | Total years of professional experience (optional). |
| Since | Year when your professional experience started (optional, must be between 1900 and 2100). |
...
| CompanyLogo | The logo of the company (optional). |
